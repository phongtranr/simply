...
const simplySetup = () => {
  ...
  */
  ...
  const setupLoadMoreFeeds = () => {
    const wrappers = (0, _documentQuerySelectorAll.default)('[data-load-more]');
    ...
    wrappers.forEach(wrapper => {
      ...
      const hideExtraPosts = () => {
        const articles = (0, _documentQuerySelectorAll.default)('.js-story', feed);
